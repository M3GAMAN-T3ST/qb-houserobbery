...
Config.PoliceOnDutyRequired = 1           -- amount of police required to be on duty to rob a house
...
Config.ChanceToAlertPolice = 50           -- chance in percent to call the police if a house robbery is in progress
